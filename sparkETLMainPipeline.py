...
import sys
#This sparkETLMainPipeline.py is a Modernized/Standardized/modularized code of spark_sql_ETL_BreadButter_2.py (Core Essence the ETL program spark_sql_ETL_BreadButter_2.py)
#inline coding approach (traditional approach)
#inline function creation and calling (scope of this function is within this module) - standard approach
#reusable function creation and calling approach - modern approach

def return_struct():#inline function
...
#1. I will start devlop the major business logics functionalities for performing DE/ETL pipeline, Inside the below main method
...
def main(arg):
    ...
    custstructtype1=return_struct()#inline function call
    #custstructtype1.printSchema()#unit testing
    ...
    #custdf_clean=spark.read.csv("file:///home/hduser/hive/data/custsmodified",mode='dropmalformed',schema=custstructtype1)#inline code
    custdf_clean=read_data('csv',spark,arg[1],custstructtype1,'dropMalformed',delim=',')#reusable function calling
    custdf_clean.printSchema()
    custdf_clean=optimize_performance(spark,custdf_clean,4,True,True,4)#reusable function calling
    ...
    reord_df2.show(10,False)#we will remove when we deploy into production
    ...
    #Usecase: Convert the above & below inline code to either inline/reusable functions
...
if __name__=="__main__":
    if(len(sys.argv)==4):
        ...
        from sparklearning.sql.reusable_functions import *
        main(sys.argv)
    else:
...
#Identify the functions flow of this program and put it in a ppt/document
#convert the wrangling inline code to inline/reusable functions